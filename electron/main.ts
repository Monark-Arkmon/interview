...
// Register the wallpaper-engine protocol
if (process.platform === "darwin") {
  app.setAsDefaultProtocolClient("wallpaper-engine")
} else {
  app.setAsDefaultProtocolClient("wallpaper-engine", process.execPath, [
...
async function initializeApp() {
  try {
    ...
    const appDataPath = path.join(app.getPath('appData'), 'wallpaper_engine')
